"""Executable Claim 2 verifier; exits nonzero on any evidence failure."""
...
from repro.claims.claim2_isp_ordering import verify_certificate
...
def main() -> int:
    ...
    print("CLAIM_2_RESULT=" + json.dumps(output, sort_keys=True))
