...
limits are negative and positive infinity. In the paper's no-worse-than-random
binary scope, the relevant finite domain is `1/2 <= x < 1`; a perfect agent
requires the positive-infinity limit.
